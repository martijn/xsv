...
class Numbers6Test < Minitest::Test
  ...
  def test_fetch_all_rows
    ...
    @workbook.sheets[0].each_row do |_row|
      rows += 1
    end
  ...
  def test_numbers_types
    ...
    expected = {"Text" => "Hi there", "Number" => 1234, nil => nil, "Date" => Date.new(2020, 2, 20),
                "Time" => "13:00", "DateTime" => Time.new(2020, 2, 20, 13, 0o0)}
  ...
  def test_fetch_all_rows_with_row_skip
    ...
    @workbook.sheets[1].each_row do |_row|
      rows += 1
    end
